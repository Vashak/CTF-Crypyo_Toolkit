...
| **`rsa_repeated_squaring.py`** | RSA | Non-invertible `e` () | Exploits $$2^{16}$$ by extracting 16 consecutive modular square roots through a quadratic residue expansion tree, operating entirely within $\mathbb{Z}_p$. |
